...
int64_t os64_read(int32_t handle, void *buf, size_t len)
{
    ...
    // PATIENCE now (abi syscall_numbers.h, ruled 2026-08-05), and before
    // this stub passed it deliberately, that register was ring-3 garbage
    // the kernel ignored. A rebuilt world always states its patience out
    // loud rather than leaving it to whatever was in r10.

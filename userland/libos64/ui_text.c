...
const os64_ui_class_t os64_ui_scrollbar_class =
    { "scrollbar", scrollbar_paint, scrollbar_event, scrollbar_cancel, 0 };
...
const os64_ui_class_t os64_ui_textfield_class =
    { "textfield", field_paint, field_event, field_cancel, 0 };
...
const os64_ui_class_t os64_ui_textview_class =
    { "textview", textview_paint, textview_event, textview_cancel, 0 };

...
static const os64_ui_class_t kStateClass = {"state sample", state_paint, NULL, NULL, NULL};
...
static const os64_ui_class_t kMenuClass = {"menu sample", menu_paint, NULL, NULL, NULL};

...
/* Load the source captured by the collection scan; do not silently switch
 * sources if the selected file disappears or becomes unreadable. */
int frame_load_entry(const frame_saved_t *,frame_draft_t *,void **,size_t *);

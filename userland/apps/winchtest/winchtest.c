...
//
// Two roles in one binary. With no argument it is the TERMINAL: it creates a
...
// handler can run and the program can ask what changed.
//
...
// It did, on 2026-08-25, before the raise went in.
//
...
int main(int argc, char **argv)
{
	...
	os64_printf("winchtest: PASS (grid follows, seats hear SIGWINCH, blocked read interrupted)\n");
	os64_exit(STEP(0));
}

...
#define DEBUG_SYSCALL (__uint128_t)1 << 19
...
// #define DEBUG_OPTIONS (__uint128_t)(DEBUG_EXCEPTIONS | DEBUG_BOOT | DEBUG_SCHEDULER | DEBUG_THREAD | DEBUG_SIGNALS | DEBUG_SMP | DEBUG_SYSCALL)
#define DEBUG_OPTIONS (DEBUG_EXCEPTIONS | DEBUG_BOOT | DEBUG_SPECIAL)

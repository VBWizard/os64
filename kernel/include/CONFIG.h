...
// | DEBUG_SPECIAL
#define DEBUG_OPTIONS (__uint128_t)(DEBUG_MINIMAL_OPTIONS | DEBUG_SCHEDULER | DEBUG_THREAD | DEBUG_DETAILED | DEBUG_EXTRA_DETAILED | DEBUG_SIGNALS | DEBUG_SMP | DEBUG_TESTS | DEBUG_TASK)

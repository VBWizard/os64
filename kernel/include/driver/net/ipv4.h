...
// neighbour and a later PARKED frame replaces it, which is why TCP holds
// its output after one until that unit is acknowledged or resent by its
// timer. DROPPED is a driver failure

...
typedef struct hid_keyboard
{
	...
	uint8_t  to_gui[32];       // ...and whose press, or a repeat, reached the GUI (its release goes there)
	uint8_t  mods_to_gui;      // HID modifier bits whose down edge reached the GUI

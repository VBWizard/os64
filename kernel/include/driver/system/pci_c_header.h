#ifndef PCI_C_HEADER_H
#define PCI_C_HEADER_H
...
static PCI_DEVTABLE	PciDevTable [] __attribute__ ((section (".hidata"))) =
{
	...
	{ 0x1b36, 0x0010, "NVMe Controller", "NVMe Controller"}, 
	{ 0x8086, 0x1237, "82440LX/EX", "PCI & Memory" } ,
	{ 0x8086, 0x2918, "828011B I/O Controller Hub", "ICH9 I/O Controller Hub"},
	{ 0x8086, 0x29c0, "82G33/G31/P35/P31 Express DRAM Contorller", "Express DRAM Controller"},
...
PCI_CLASSCODETABLE PciClassCodeTable [] =
{
	...
	{ 0x00, 0x01, 0x00, "Image coprocessor","", ""},
	{ 0x01, 0x00, 0x00, "Mass Storage Controller", "SCSI", "" } ,
	{ 0x01, 0x01, 0x00, "ISA Compatibility mode-only controller", "IDE", "" } ,
	{ 0x01, 0x01, 0x05, "PCI native mode-only controller", "IDE", "" } ,
	{ 0x01, 0x01, 0x0a, "ISA Compatibility mode controller, supports both channels switched to PCI native mode", "IDE", "" } ,
	{ 0x01, 0x01, 0x0f, "PCI native mode controller, supports both channels switched to ISA compatibility mode", "IDE", "" } ,
	{ 0x01, 0x01, 0x80, "ISA Compatibility mode-only controller, supports bus mastering", "IDE", "" } ,
	{ 0x01, 0x01, 0x85, "PCI native mode-only controller, supports bus mastering", "IDE", "" } ,
	{ 0x01, 0x01, 0x8a, "ISA Compatibility mode controller, supports both channels switched to PCI native mode, supports bus mastering", "IDE", "" } ,
	{ 0x01, 0x01, 0x8f, "PCI native mode controller, supports both channels switched to ISA compatibility mode, supports bus mastering", "IDE", "" } ,
	...
	{ 0x01, 0x07, 0x00, "Serial Attached SCSI Controller", "SATA", "" },
	{ 0x01, 0x08, 0x00, "Non-Volatile memory Controller", "SATA", "" },
	{ 0x01, 0x09, 0x00, "Universal Flash Storage Controller", "SATA", "" },
	...
	{ 0x03, 0x01, 0x00, "3D  Controller", "VGA", "" } ,
	...
	{ 0x0C, 0x03, 0x00, "Serial Bus Controller", "USB (Universal Serial Bus)", "UHCI" } ,

	{ 0x0C, 0x03, 0x10, "Serial Bus Controller", "USB (Universal Serial Bus)", "OHCI" } ,
	{ 0x0C, 0x03, 0x20, "Serial Bus Controller", "USB (Universal Serial Bus)", "EHCI" } ,
	{ 0x0C, 0x03, 0x30, "Serial Bus Controller", "USB (Universal Serial Bus)", "XHCI" } ,
	{ 0x0C, 0x03, 0x40, "Serial Bus Controller", "USB (Universal Serial Bus)", "USB4 Host Interface" } ,
	{ 0x0C, 0x03, 0x80, "Serial Bus Controller", "USB (Universal Serial Bus)", "Unspecified" } ,
	{ 0x0C, 0x03, 0xFE, "Serial Bus Controller", "USB (Universal Serial Bus)", "USB Device" } ,

...
//
// Emits to BOTH sinks, and that is deliberate: printf reaches the glass a human
// is watching, printd reaches the wire a script can grep, and a crash report
// that exists in only one of those places is the failure mode this whole slice
// was built to end.

...
cc -D_XOPEN_SOURCE=700 -pthread -std=c11 -fno-builtin-memmove -g -O1 -Wall -Wextra -Werror -ffunction-sections -fdata-sections \
    ...
    tools/test_appearance_host.c tools/test_appearance_session_host.c userland/libos64/ui.c \
    userland/libos64/ui_theme.c userland/libos64/ui_session.c userland/libos64/ui_palette.c userland/libos64/ui_controls.c \
    ...
    -Wl,--gc-sections,--wrap=os64_conf_find_read -o "$appearance_test_dir/test_appearance"
